     ...
     <nav class="board-bar">
         ...
         <!-- Sử dụng Usecase với trường hợp sử dụng là thêm thông tin mượn phòng học
             điều hướng với điều kiện:
                 ...
                 UIDManager
         -->
         <a class="add-object" href="../TTMuonPhongHoc/index.html?UC=DsMPH&Form=ThemTTMPH&UIDManager=123456987">Thêm lịch mượn phòng</a>
     </nav>
     <table>
         <thead>
             <tr>
         ...
         <tbody>
             ...
             <tr onclick="location.href = '../TTMuonPhongHoc/index.html?UC=MPH&Display=YCMPH&UIDRegular=123456987&MaLMPH=B100213&MaLH=L123&GiangVien=Nguy%E1%BB%85n%20%C4%90%E1%BB%A9c%20Th%E1%BB%8Bnh&MaLopSV=D22CQCN01-N&MaMH=INT1359-3&TenMH=To%C3%A1n%20r%E1%BB%9Di%20r%E1%BA%A1c%202&MaPH=2B31&ThoiGian_BD=7%3A00%2002%2F03%2F2024&ThoiGian_KT=10%3A30%2002%2F03%2F2024&HinhThuc=H%E1%BB%8Dc%20th%E1%BB%B1c%20h%C3%A0nh&LyDo=&TrangThai=Ch%C6%B0a%20m%E1%BB%B1%E1%BB%9Dn&NgMPH=&VaiTro=&QL_Duyet=&YeuCau=';">
             ...
             <!-- Test data rỗng -->
             <tr onclick="location.href = '../TTMuonPhongHoc/index.html?UC=DsMPH&Display=TTMPH&UIDManager=123456987';">
