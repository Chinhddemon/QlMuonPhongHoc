    ...
    <form class="board-content">
      ...
      <label class="NhomTo">
        ...
        <c:if test="${NextUsecaseSubmitOption1 == null && NextUsecasePathSubmitOption1 == null 
          ...
          <c:if test="${CTLopHocPhan != null && (CTLopHocPhanSection == null || CTLopHocPhanSection.nhomTo == '00')}">
            <input type="text" disabled value="${CTLopHocPhan.nhom}">
          </c:if>
          <c:if test="${CTLopHocPhanSection != null && CTLopHocPhanSection.nhomTo != '00' && CTLopHocPhanSection.nhomTo != ''}">
            <input type="text" disabled value="${CTLopHocPhan.nhom}-${CTLopHocPhanSection.nhomTo}">
          </c:if>
        </c:if>
        <c:if test="${NextUsecaseSubmitOption1 != null && NextUsecasePathSubmitOption1 != null 
                    || NextUsecaseSubmitOption2 != null && NextUsecasePathSubmitOption2 != null}">
            ...
            <input class="To" type="text" disabled style="max-width: 50px;"
      ...
      <div class="submit">
        ...
        <button class="submit-object" type="submit" onclick="history.back();history.back()" formaction="#">
          Cập nhật
        </button>
        <button class="conform-object" type="submit" onclick="history.back();history.back()" formaction="#">
          Xác nhận
        </button>
      </div>
