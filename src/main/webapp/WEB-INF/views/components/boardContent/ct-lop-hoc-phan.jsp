...
&& NextUsecaseSubmitOption2 == null && NextUsecasePathSubmitOption2 == null}">
					<c:if
						test="${CTLopHocPhan != null && (CTLopHocPhanSection == null || CTLopHocPhanSection.nhomTo == '00')}">
						<input type="text" disabled value="${CTLopHocPhan.nhom}">
					</c:if>
					<c:if
						test="${CTLopHocPhanSection != null && CTLopHocPhanSection.nhomTo != '00' && CTLopHocPhanSection.nhomTo != ''}">
				...
				<c:if test="${NextUsecaseSubmitOption1 != null && NextUsecasePathSubmitOption1 != null 
	|| NextUsecaseSubmitOption2 != null && NextUsecasePathSubmitOption2 != null}">
					<input class="Nhom" type="text" disabled required style="max-width: 50px;"
						pattern="[0-9]{2}" maxlength="2" value="${CTLopHocPhan.nhom}">
					<input class="To" type="text" disabled style="max-width: 50px;" pattern="[0-9]"
						maxlength="2" placeholder=""
						value="${CTLopHocPhanSection.nhomTo == '00' ? '' : CTLopHocPhanSection.nhomTo}">
				</c:if>
			</label>
			<label class="LopSV">
			...
			<label class="Ngay_BD LHP-Root">
				...
				<input type="date" disabled name="ThoiGian_KT" value="${CTLopHocPhanRoot.ngay_BD}">
			</label>
			<label class="Ngay_KT LHP-Root">
				<span>Giai đoạn kết thúc: </span>
				<input type="date" disabled name="ThoiGian_KT" value="${CTLopHocPhanRoot.ngay_KT}">
			</label>
			<!-- MARK: Second Section -->
			<c:if test="${CTLopHocPhanSection != null}">
				<br>
				...
				<label class="MucDich LHP-Section">
					<span>Hình thức học: </span>
					<select disabled required name="MucDich LHP-Section">
						<option disabled selected hidden value="">
							Chọn hình thức
						</option>
						<option value="LT">
				...
				<label class="Ngay_BD LHP-Section">
					<span>Giai đoạn bắt đầu: </span>
					<input type="date" disabled name="ThoiGian_KT"
			...
			<div class="submit">
				...
				<button class="submit-object" type="submit" onclick="history.back();history.back()"
					formaction="#">
					Cập nhật
				</button>
				<button class="conform-object" type="submit" onclick="history.back();history.back()"
					formaction="#">
					Xác nhận
				</button>
			</div>
