...
<body>
    <nav class="board-bar">
        ...
        <a class="add-object" href="../TTMuonPhongHoc/index.html?Usecase=TTMPH&Form=ThemTTMPH&UIDManager=123456987">Thêm lịch mượn phòng</a>
    </nav>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <!-- Test data rỗng -->
            <tr onclick="location.href = '../TTMuonPhongHoc/index.html?Usecase=TTMPH&Display=XemTTMPH&UIDManager=123456987';">
