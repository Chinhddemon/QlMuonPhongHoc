...
public class CTLopHocPhan {
  ...
  @RequestMapping(value = "SuaTTLHP", method = RequestMethod.POST)
    ...
    NhomHocPhan CTLopHocPhan = layThongTinLopHocPhan(IdLHP);
    if(CTLopHocPhan == null) {System.out.println("CTLopHocPhan null");
    ...
    if(FirstSection == null) {System.out.println("FirstSection null");
      redirectAttributes.addFlashAttribute("errorMessage", "Không tìm thấy thông tin lớp học phần.");
      return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
    }
    ...
    if(!layIdSection(IdLHP).equals("000000")) {
      ...
      if(SecondSection == null) {System.out.println("SecondSection null" + layIdSection(IdLHP));
        redirectAttributes.addFlashAttribute("errorMessage", "Không tìm thấy thông tin lớp học phần.");
        return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
      }
    }
    ...
    if(SecondSection != null) {
      if(MaGVSection == null || MucDichSection == null || Ngay_BDSection == null || Ngay_KTSection == null) {
        redirectAttributes.addFlashAttribute("errorMessage", "Thông tin không hợp lệ, vui lòng nhập đầy đủ thông tin.");
        return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
      }
    ...
    if(!lopHocPhanSectionService.capNhatThongTin(FirstSection)) {System.out.println("FirstSection failed");
      redirectAttributes.addFlashAttribute("errorMessage", "Không thể cập nhật thông tin lớp học phần.");
      return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
    }
    if(SecondSection != null && !lopHocPhanSectionService.capNhatThongTin(SecondSection)) {System.out.println("SecondSection failed");
      redirectAttributes.addFlashAttribute("errorMessage", "Không thể cập nhật thông tin lớp học phần.");
      return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
    }
    if(!nhomHocPhanService.capNhatThongTin(CTLopHocPhan)) {System.out.println("CTLopHocPhan failed");
      redirectAttributes.addFlashAttribute("errorMessage", "Không thể cập nhật thông tin lớp học phần.");
      return "redirect:/CTLHP/XemTTLHP.htm?UID=" + uid + "&IdLHP=" + IdLHP;
    }
