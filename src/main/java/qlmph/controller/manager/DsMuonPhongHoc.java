...
public class DsMuonPhongHoc {
	...
	public String showDsMPH(Model model) {
		...
		// Dữ liệu mẫu
		DsLichMPH.add(new TTLichMPH("D100214", "L125", "Nguyễn Thị Bích Nguyên", "D21DCCN01-N", "INT1340", "Nhập môn công nghệ phầm mềm",
		...
		DsLichMPH.add(new TTLichMPH("D100214", "L125", "Nguyễn Thành Trung", "D21DCCN01-N", "INT1340", "Nhập môn công nghệ phầm mềm",
				"2A08", "13:00 28/02/2024", "16:30 28/2/2024", "Học lý thuyết", "Đổi phòng học khác", "Đã mượn", "Ngô Cao Hy", "Sinh Viên", "Thái Văn Anh Chính",
				"12:58 28/2/2024", "MC + K + MT"));
