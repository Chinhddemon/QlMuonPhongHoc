...
public class DsLopHocPhanController {
    ...
    @RequestMapping("/XemDsHocPhan") // MARK: - XemDsHocPhan
    public String showDsHocPhan(Model model,
        ...
        model.addAttribute("NextUsecaseNavOption1", "DsNhomHocPhan");
        model.addAttribute("NextUsecasePathNavOption1", "XemDsNhomHocPhan");
