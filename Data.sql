...
GO
INSERT [dbo].[TaiKhoan] ([IdTaiKhoan], [IdVaiTro], [TenDangNhap], [MatKhau], [_CreateAt], [_UpdateAt], [_DeleteAt]) VALUES (N'4be7a04a-4ab6-4b54-ad08-32c77698d9be', 2, N'manager4569', N'hashedpassword2                                             ', CAST(N'2024-04-07T17:05:42.753' AS DateTime), CAST(N'2024-04-08T20:04:27.827' AS DateTime), NULL)
INSERT [dbo].[TaiKhoan] ([IdTaiKhoan], [IdVaiTro], [TenDangNhap], [MatKhau], [_CreateAt], [_UpdateAt], [_DeleteAt]) VALUES (N'5c339353-434a-4cb0-8980-f6554f7009c5', 1, N'user1237', N'hashedpassword1                                             ', CAST(N'2024-04-07T17:05:42.753' AS DateTime), CAST(N'2024-04-08T20:04:52.147' AS DateTime), NULL)
INSERT [dbo].[TaiKhoan] ([IdTaiKhoan], [IdVaiTro], [TenDangNhap], [MatKhau], [_CreateAt], [_UpdateAt], [_DeleteAt]) VALUES (N'08ea16ce-9257-43bc-a9a5-f66ab477b1aa', 3, N'admin7899', N'hashedpassword3                                             ', CAST(N'2024-04-07T17:05:42.753' AS DateTime), CAST(N'2024-04-08T20:04:52.183' AS DateTime), NULL)
GO
...
GO
INSERT [dbo].[NguoiMuonPhong] ([MaNgMPH], [IdTaiKhoan], [IdDoiTuongNgMPH], [HoTen], [Email], [SDT], [NgaySinh], [GioiTinh], [DiaChi]) VALUES (N'GV002', N'5c339353-434a-4cb0-8980-f6554f7009c5', 1, N'Nguyễn Thị B', N'nguyenthib@example.com', N'0123456789      ', CAST(N'1995-10-20' AS Date), 0, N'Hồ Chí Minh, Việt Nam')
INSERT [dbo].[NguoiMuonPhong] ([MaNgMPH], [IdTaiKhoan], [IdDoiTuongNgMPH], [HoTen], [Email], [SDT], [NgaySinh], [GioiTinh], [DiaChi]) VALUES (N'SV001', N'4be7a04a-4ab6-4b54-ad08-32c77698d9be', 2, N'Trần Văn A', N'tranvana@example.com', N'0987654321      ', CAST(N'1990-05-15' AS Date), 1, N'Hà Nội, Việt Nam')
GO
